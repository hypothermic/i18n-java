...
public class JsonSerializationTest {
    ...
    public void testGsonSerialization() {
        Gson gson = new GsonBuilder().registerTypeAdapter(JsonI18nFormat.COLLECTION_TYPE, new JsonI18nResourceSerializer()).create();
        ...
        Collection<II18nResource> deserialized = gson.fromJson(gson.toJson(resources, JsonI18nFormat.COLLECTION_TYPE), JsonI18nFormat.COLLECTION_TYPE);
    ...
    /**
     * Tests the higher-level JsonI18nFormat implementation
     */
    @Test
    public void testWrappedSerialization() {
        ...
        JsonI18nFormat reader = new JsonI18nFormat();

        for (II18nResource resource : reader.format(sampleInputData)) {
            verifySampleDataResource(resource);
        }
    }
